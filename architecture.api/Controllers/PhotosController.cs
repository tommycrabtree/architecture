...
namespace architecture.api.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IArchitectureRepository repo, IMapper mapper,
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            return BadRequest("Could not set photo to be the Main Photo");
        ...
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.IsMain)
                return BadRequest("Not allowed to delete the main photo");
